...
//kalo sesi admin_edit_akun tidak ada, di redirect ke halaman logout
if(!isset($_SESSION["admin_edit_akun"])){
...
//ambil data admin
$raws = getData("SELECT * FROM admin WHERE username = '$uname'")[0];


//
if(isset($_POST['sbmt'])){
    $cek = updateDataAdmin($_POST);
    if($cek > 0){
        echo "
        <script> 
        alert('data berhasil diubah');
        document.location.href = '$path_main';
        </script>";

        //hilangkan sesi untuk admin edit akun
        $_SESSION["admin_edit_akun"] = false;
        }
...
elseif(isset($_POST['sbmt-cancel'])){
    //hilangkan sesi untuk admin edit akun
    $_SESSION["admin_edit_akun"] = false;
}
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= $path_setting_admin; ?>">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="admin_id" value="<?= $raws["admin_id"];?>">
                                            <div class="row mb-1">
                                                <div class="col-md-2">Username</div>
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="formGroupExampleInput" name="uname" value="<?= $raws['username']?>" autocomplete="off" Required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-1">
