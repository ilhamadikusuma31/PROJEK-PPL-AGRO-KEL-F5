		    ...
		    <div class="form-wrapper">
				<div class="form-header">
					<span class="form-title">
						Daftar to <strong>Gemol Indonesia</strong>
					</span>
				</div>

				<form class="form-content" method="POST">
					<div class="input-wrapper">
						<input class="input-style" type="text" name="uname" placeholder="Username" id="username" autocomplete="off" required>
					...
					<div class="input-wrapper">
						<div class="input-group">
							<input class="form-control" type="password" placeholder="Konfirmasi Password" id="password" name="pass2" autocomplete="off" required>
							<span class="form-control-focus"></span>
							<div class="input-group-addon" onclick="passwordVisibility();">
								<i class="fa fa-eye" id="showPass"></i>
								<i class="fa fa-eye-slash d-none" id="hidePass"></i>
