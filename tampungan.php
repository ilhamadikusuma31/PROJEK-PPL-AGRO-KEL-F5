                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= $path_logout; ?>" data-toggle="modal"
                                    data-target="#popUpConfirmLogout">
                        ...
                        <div class="col mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <a href="<?= $path_tambah_brg; ?>"> <button type="button"
                                            ...
                                            <div class="table-responsive">
                                                <table id="table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?= $angka++ ?></td>
                                                            <td><img src="<?= $path_img; ?>/<?= $r['foto_barang']  ?>"
                                                                    width="150px" /></td>
                                                            <td><?= $r['nama_barang']  ?></td>
                                                            ...
                                                            <td>
                                                                <a
                                                                    href="<?= $path_edit_brg; ?>?id=<?= $r['barang_id']  ?>"><button
                                                                        type="button"
                                                                        class="btn btn-sm btn-warning mt-1">edit⠀</button></a>
                                                                <a href="<?= $path_hapus_brg; ?>?id=<?= $r['barang_id']  ?>"
                                                                    onclick="return confirm('Apakah Anda yakin ingin menghapus barang ini?')"><button
                                                                        type="button"
                                                                        class="btn btn-danger btn-sm mt-1">hapus</button></a>
                                                            </td>
                                                        </tr>
                                                        <?php endforeach ?>
                                                    </tbody>
